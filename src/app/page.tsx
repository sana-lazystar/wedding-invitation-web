...
// 진입 장면(로딩)은 편지봉투입니다(디자인 논의 T36~T45). 편지지는 커버 자체이고, 봉투 안에서는 봉투 폭의 92%로 있다가 올라오며 화면 폭이 됩니다. 층(바탕 < 뒷판 < 커버 < 앞판 < 뚜껑)이고, 배율과 카드 값은 화면 크기에서 계산해 CSS 변수로 넣고, 봉투 그림이 준비되면 시작합니다. 어디를 탭해도 건너뜁니다.
