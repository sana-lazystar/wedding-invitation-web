...
| 기다리는 것 | 카카오 콘솔의 도메인 등록 · 카카오맵 활성화(T113) · 실제 계좌번호 · 신부대기실 시각(U-5) · 연락처 블록 여부 |
