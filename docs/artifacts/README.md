...
- 다음: 남은 장면은 없습니다. OG · 카카오톡 공유 설정은 조사만 했고(T127) 이산하의 결정(OG 이미지 소재 · 공유 버튼 여부)을 기다립니다. 사진첩은 이산하가 준 원본 44장이고 타일은 1~8 + "+36개"입니다(T121). 웨딩 사진 셋(신랑 · 신부 · 함께 있는 컷)은 T83에 Scene6~8에 들어갔습니다. 캐릭터 원본은 `../design/character/`에 기본 표정 둘과 다른 포즈 열하나(수달 1~4, 토끼 1~6, 둘이 허그)가 있습니다(T52 · T128)
