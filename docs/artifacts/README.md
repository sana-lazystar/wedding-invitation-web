...
- 완료: 진입 장면(편지봉투) · Scene1 커버(와이어프레임 2쪽) · Scene2 핵심 정보(3쪽, 올리브 가지) · 떠 있는 바로 가기 메뉴(T132에 테이프 붙인 쪽지로. 오시는 길 · 사진첩 · 마음 전하는 곳 · 공유하기) · 카카오톡 공유 · OG 미리보기(T132) · 배경 음악(T137 · T138, 첫 동작에서 시작 · 오른쪽 위 음표). 아래 "떠 있는 메뉴 · 공유 · OG (쪽지)" · "배경 음악 (음표 스티커)"
