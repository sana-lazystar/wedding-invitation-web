...
| 에셋 | 종이 `public/paper/note.png` · 가지 `public/scene2/branch.png` · 봉인 `public/intro/rose-seal.png`을 다시 씁니다. 머리 그림 제안(`assets/icon-directions.svg` 멀리서 날아오는 새 셋 · `icon-guide.svg` 김 오르는 찻잔 · `icon-gift.svg` 튤립 한 송이. 올리브 가지와 같은 도장 실루엣, 200×200. T118. T112의 핀 · 손종 · 봉투와 T116의 사람들은 너무 직설적이라 지움)은 이산하가 고르면 `public/scene11~13/`에 1배로 산출해 `.sheet__branch` 자리에 26px로 넣습니다 |
